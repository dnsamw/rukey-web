...
export default function SettingsPage() {
  ...
  const handleSave = async () => {
    ...
    const responses = await Promise.all(
      updates.map(({ key, value }) => saveSetting(key, value)),
    );

    const hasError = responses.some((r) => Boolean(r.error));
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    onClick={() => {
                      setTheme((p) => ({
                        ...p,
                        [key]: defaultTheme[key as keyof typeof defaultTheme],
                      }));
                    }}

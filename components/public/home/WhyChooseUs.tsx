      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="h-1 w-16 bg-[#F97316] rounded-full mb-10" />

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {reasons.map(({ icon: Icon, title, description }) => (
                <div key={title} className="flex gap-4">
                  <div className="w-11 h-11 bg-[#F97316]/10 rounded-xl flex items-center justify-center shrink-0 mt-0.5">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-72 bg-white rounded-2xl p-5 shadow-2xl">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xs font-bold text-[#1E3A5F]">Sarah J.</div>
